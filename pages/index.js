    ...
    <div className="dark:text-white dark:bg-black">
      ...
      <div className="flex px-5 sm:px-20 md:px-40 py-5">
        <div class="flex-2 text-auto px-2">
          <p className="py-2">
          Hi! I'm Jerry! I'm 23, born & raised in NYC where I went to Stuyvesant High School.
          </p>
          ...
          <ul className="py-2 list-disc list-inside space-y-1">
            <li>As a kid, I sold Yu-Gi-Oh! cards for cash. My parents wouldn't let me order online, so I had to ship everything to a friend's house and pay him a "handling fee"—still turned $20 into $10K.</li>
            <li>I've been top ranked at many games (1200 LP Challenger / Rank 80 NA in TFT, Top 10 DN ranking in yugioh, top 100 backyard monsters player worldwide, Diamond 2 in league of legends, etc)</li>
            <li>In high school, I broke into NYC's health policy world to stand out for college apps. I hustled my way into speaking at conferences, built relationships from scratch, launched city-wide initiatives, and became the youngest intern at the Department of Education. Unironically, years later, this became the best crash course into how to hustle in business.</li>
          </ul>
          <p className="py-2">
